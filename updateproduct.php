    ...
    <div id="content">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-12">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="updateproduct.php">Update Product</a></li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="form-group row">
            <label for="txteid" class="col-sm-2 col-form-label">Prod ID</label>
            <div class="col-sm-3">
                <input type="text" class="form-control" id="txteid" name="txteid" readonly="readonly">
            </div>
        </div>
        <div class="form-group row">
            <label for="txteid" class="col-sm-2 col-form-label">Re order level</label>
            <div class="col-sm-3">
                <input type="text" class="form-control" id="txtreorder" name="txteid" readonly="readonly">
            </div>
        </div>
